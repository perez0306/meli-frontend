    ...
    <aside className={styles.box}>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.iconsRow}>
          ...
          />
          <Image
            src="https://http2.mlstatic.com/storage/logos-api-admin/f1fc5b20-f39b-11eb-a186-1134488bf456-m.svg"
            alt="Codensa"
            title="Codensa"
            width={54}
            height={28}
      ...
      <div className={styles.section}>
        ...
        <div className={styles.iconsRow}>
          <Image
            src="https://http2.mlstatic.com/storage/logos-api-admin/e5ee1d00-f39b-11eb-8e0d-6f4af49bf82e-m.svg"
            alt="Efecty"
            title="Efecty"
            width={80}
            height={28}
